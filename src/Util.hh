...
namespace Util {
    ...
    uint splitString(const std::string &str, std::vector<std::string> &toks, const std::string &sep, uint max = 0, bool include_empty = false, char quote = '\0');
    std::string escapeChar(const std::string &str, const char chr);
